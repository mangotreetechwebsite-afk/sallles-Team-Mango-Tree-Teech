      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/50 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              By completing the transaction of ₹1,199, you acknowledge and agree that all payments are 100% Non-Refundable as customized digital analysis work begins immediately upon order receipt.
            </p>
          </div>
